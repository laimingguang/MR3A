...
- ✅ **竞技场** - 自动进行竞技场跑酷（跑酷挂机，老板娘问答随机选择）
- ✅ **忍村试炼** - 自动挑战试炼关卡（支持1-5关自定义配置，可选择保留包子数量）
- ✅ **免费召唤** - 自动进行免费召唤（支持4000/8000忍币召唤白银武库开关）
...
- ✅ **领取战令** - 自动领取战令奖励
- ✅ **忍阶任务** - 自动领取每日忍阶声望
- ✅ **每日藏宝图** - 自动刷取每日任务藏宝图（支持属性选择：神炎国/海之国/雷王山/云之国/任意属性）
- ✅ **神品传颂藏宝图** - 专刷神品和传颂品质藏宝图
- ✅ **S/SS/SS+悬赏** - 专刷高级悬赏（跳过ABCD悬赏）
...
### 重要提醒 
1. 请在游戏设置中关闭好友组队邀请功能
2. 新版本会自动检测更新，可通过设置中选择 github 自动更新，或者进[用户QQ群](#user-qq-group) 获取新版本更新提醒
