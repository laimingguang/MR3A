...
- ✅ **启动游戏** - 自动启动《忍者必须死3》应用（支持官服/vivo服切换）
- ✅ **神龙契约** - 自动领取神龙契约奖励
...
### 新手上路
绝大部分用户下载 [release](https://github.com/originalsage/MR3A/releases/latest) 中的 `MR3A-win-x86_64-vxxx.zip` 压缩包即可。
...
<div align="center">
  ...
  **项目持续开放中，有bug请联系开发者qq:3625720746**
